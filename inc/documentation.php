	...
	<div class="wrap about-wrap">
		...
		<div id="tab_container">
			...
			<div class="section">
				...
				<p><?php printf( __('Please read <a href="%1$s" target="_blank"><strong>readme.txt</strong> file</a> to know about theme component. You can visit <a href="%2$s" target="_blank">theme page</a> on my website.', 'mahal'), home_url('wp-content/themes/mahal/readme.txt'), 'https://blog.dhimaskirana.com/mahal-wordpress-themes' ); ?></p>
